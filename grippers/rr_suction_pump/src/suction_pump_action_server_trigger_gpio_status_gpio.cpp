...
public:
            ...
            , _action_name(action_name)
    {
        ...
        _pump = std::unique_ptr<Pump<HI_Trigger, HI_Status, Config_Trigger, Config_Status, bool, bool>>(new Pump<HI_Trigger, HI_Status, Config_Trigger, Config_Status, bool, bool>(trigger_gpio, trigger_num, status_gpio, status_num, outputNormallyOn, inputNormallyOn));
    }
...
private:
    std::unique_ptr<Pump<HI_Trigger, HI_Status, Config_Trigger, Config_Status, bool, bool>> _pump;
